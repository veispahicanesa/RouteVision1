...
public class Vozac {
    ...
    public String getBroj_vozacke_dozvole() {
        return broj_vozacke_dozvole;
    }

    public void setBroj_vozacke_dozvole(String broj_vozacke_dozvole) {
        this.broj_vozacke_dozvole = broj_vozacke_dozvole;
    }

    public String getKategorija_dozvole() {
        return kategorija_dozvole;
    }

    public void setKategorija_dozvole(String kategorija_dozvole) {
    ...
    public int getBroj_dovrsenih_tura() {
        return broj_dovrsenih_tura;
    }

    public void setBroj_dovrsenih_tura(int broj_dovrsenih_tura) {
    ...
    public String getAktivna_slika() {
        return aktivna_slika;
    }

    public void setAktivna_slika(String aktivna_slika) {
        this.aktivna_slika = aktivna_slika;
    }
